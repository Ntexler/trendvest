        ...
        "stages": [
            {
                ...
                "name": "Raw Materials",
                "name_he": "חומרי גלם",
                "commodities": ["copper", "silicon", "gold", "silver", "palladium", "rare_earths"],
        ...
        "stages": [
            {
                ...
                "name_he": "כרייה",
                "commodities": ["lithium", "cobalt", "nickel", "manganese", "graphite"],
    ...
    "food": {
        ...
        "stages": [
            ...
            },
            {
                ...
                "name_he": "ייצור חקלאי",
                "commodities": ["wheat", "corn", "soybeans", "coffee"],
                "regions": ["us", "south_america", "asia", "europe"],
                "countries": ["US", "Brazil", "Argentina", "Ukraine", "India"],
            },
            {
                "stage": "processing",
